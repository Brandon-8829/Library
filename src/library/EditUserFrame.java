...
public class EditUserFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("What would you like to do with the user:");

        jLabel2.setText("[Username goes here]");
    ...
    private void delUButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delUButtonActionPerformed
        ...
        int selectedUser = ActiveId.activeUser;
        UserData.userSize--;
        for(int i = selectedUser; i < UserData.userSize; i++){
            UserData.logins[selectedUser] = UserData.logins[selectedUser+1];
        }
